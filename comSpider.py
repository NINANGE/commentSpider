...
def settingNameCode(itemName):
    ...
    if nameCode == 'KOI8-R' or nameLanguage== 'Russian' or nameCode == 'ISO-8859-1' or nameCode == 'ISO-8859-7' or nameLanguage== 'Thai' or nameLanguage=='Bulgarian' or nameCode==None:
